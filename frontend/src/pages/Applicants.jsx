...
function Applicants() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/applicants`)
      .then((response) => {
    ...
    <div className="applicants-page">
      ...
      <div className="applicants-header">
        <div>
          ...
          <span>Manage candidates who applied for your jobs.</span>
        </div>
      </div>
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            const response = await axios.put(
                              `${import.meta.env.VITE_API_URL}/applicants/${applicant._id}/status`,
                              {
                                status: newStatus,
                              },
                            );
